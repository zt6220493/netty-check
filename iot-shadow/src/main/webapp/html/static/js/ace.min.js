...
ace.helper.collapsible = function() {
    var e;
    var sidebar = null;
    if ($("#sidebar.navbar-collapse").length >0){
    	sidebar = $("#sidebar.navbar-collapse")[0];
    }
    var navbar= null;
    if ($('.navbar-toggle[data-target*=".sidebar"]').length >0){
    	navbar = $('.navbar-toggle[data-target*=".sidebar"]')[0];
    }
//  return null != document.querySelector("#sidebar.navbar-collapse") && null != (e = document.querySelector('.navbar-toggle[data-target*=".sidebar"]')) && e.scrollHeight > 0
    return null != sidebar && null != (e = navbar) && e.scrollHeight > 0
},
